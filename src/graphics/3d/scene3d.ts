...
export class Scene3D {
    ...
    public render(): void {
        ...
        this.gl.uniform3f(this.shader.getUniformLoc("u_camera.position"),
            this.camera.position.x, this.camera.position.y, this.camera.position.z);
        this.gl.uniform3f(this.shader.getUniformLoc("u_camera.forward"),
            camForward.x, camForward.y, camForward.z);
        this.gl.uniform3f(this.shader.getUniformLoc("u_camera.right"),
            camRight.x, camRight.y, camRight.z);
        this.gl.uniform3f(this.shader.getUniformLoc("u_camera.up"),
            camUp.x, camUp.y, camUp.z);
        this.gl.uniform1f(this.shader.getUniformLoc("u_camera.viewMod"),
            20.0);
        this.gl.uniform2f(this.shader.getUniformLoc("u_resolution"),
